const About = () => {
    return (
      <section id="about" className=" min-h-screen h-full bg-gray-300 w-full  flex items-center justify-center text-xs sm:text-sm">
        <div className="max-w-4xl shadow-2xl p-4 rounded">
          <h2 className="text-4xl font-bold text-gray-800  mb-6">About Me</h2>
          
          <p className="text-sm sm:text-lg text-justify text-gray-900 leading-relaxed">
